...
const Todo = () => {
    ...
    // const [disable, setDisable] = useState(items)
    ...
    const addItem = () => {
        if (!inputData) {
            ...
            const allInputData = { id: new Date().getTime().toString(), name: inputData, disabled: false }
    ...
    const toggleComplete = (i)=>{
        ...
        setItems(items.map((todo)=>{
            console.log(i);
            console.log(todo.id);
            return todo.id == i ? {...todo, disabled: !todo.disabled} : {...todo}
        }))
        console.log(i);
    }
